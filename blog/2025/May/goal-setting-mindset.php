...
<body>
  ...
  <section class="blog-section">
      ...
      <main class="blog-main container">
        <!-- Full-Width Title -->
        <h2 class="post-title-fullwidth">Mindset and Goal Setting: A Winning Combo</h2>
    ...
    <span class="post-categories">
        ...
        <a hidden href="/category/wordcraft.php" class="post-category"> wordcraft  </a>
            ...
            <div class="post-content">
              ...
              <p>    <p>Goal-setting is powerful — but without the right mindset, goals can become sources of stress or disappointment. A growth-oriented and positive mindset is essential for sustainable motivation and success.</p>
