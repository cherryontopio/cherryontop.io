<?php
$publishDate = '2025-05-16';  // <-- Actual post publish date here
        ...
        <article class="blog-post">
          ...
          <div class="post-content">
            ...
            <ul>
              ...
              <br>
              <li><b>JavaScript:</b> Ideal if you’re interested in websites and web apps.</li>
              <br>
              <li><b>Scratch:</b> A visual language created by MIT that’s great for absolute beginners (especially kids, but adults too).</li>
            </ul>
