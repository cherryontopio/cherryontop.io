    ...
    <span class="post-categories">
        ...
        <a hidden href="/category/tech-writing-translations.php" class="post-category"> wordcraft  </a>
            ...
            <div class="post-content">
              ...
              <p>In programming, I find myself applying the same skills. To code well, I need to understand how different parts of the code interact and anticipate how users will engage with the final product. As with translation, it’s all about making things clear and relevant for the end user. </p> <p>Both translators and programmers have to interpret abstract ideas and rely on specific tools — grammar and idioms, or code libraries and syntax — to convey meaning in the most accurate, effective way. My experience reading between the lines as a translator now helps me grasp the intent behind each line of code.</p>
