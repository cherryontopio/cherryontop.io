...
$pageTitle = basename(__FILE__, '.php') === 'index' ? "Welcome to My Website" : "Posts in Category Travels";
...
<body><!-- Hero Section with Background Image -->
  <div class="hero-category-travels">
    <div class="hero-content">
      <h1 class="title">Travels</h1>
      <p class="subtitle">Living the Nomadic Lifestyle</p>
  ...
  <section class="categories">
    <?php include '../includes/post-card-travels.php'; ?>
